...
class JanelaPrincipal:
    ...
    def _criar_layout(self):
        ...
        self.label_cliente = ctk.CTkLabel(self.janela_principal, text="Cliente:")
        self.label_cliente.grid(row=linha, column=0, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="w")

        self.entrada_cliente = ctk.CTkEntry(self.janela_principal)
        self.entrada_cliente.grid(row=linha, column=1, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="we")
        self.controles['entrada_cliente'] = self.entrada_cliente
        linha += 1

        self.label_email = ctk.CTkLabel(self.janela_principal, text="E-mail cliente:")
        self.label_email.grid(row=linha, column=0, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="w")

        self.entrada_email = ctk.CTkEntry(self.janela_principal)
        self.entrada_email.grid(row=linha, column=1, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="we")
        self.controles['entrada_email'] = self.entrada_email

        self.label_senha = ctk.CTkLabel(self.janela_principal, text="senha:")
        self.label_senha.grid(row=linha, column=2, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="w")

        self.entrada_senha = ctk.CTkEntry(self.janela_principal, width=15, show="*")
        ...
        ctk.CTkLabel(self.janela_principal, text="Sistema emissor:").grid(row=linha, column=0, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="w")
        self.sistema_cb = ctk.CTkOptionMenu(self.janela_principal, width=15)
        self.sistema_cb.grid(row=linha, column=1, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="ew")
        sistemas = ["SmallSoft", "Comercial"]
        self.sistema_cb.configure(values=sistemas)
        self.controles['sistema_cb'] = self.sistema_cb

        ctk.CTkLabel(self.janela_principal, text="Modo de envio:").grid(row=linha, column=2, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="w")
        self.modo_envio_cb = ctk.CTkOptionMenu(self.janela_principal, width=15)
        self.modo_envio_cb.grid(row=linha, column=3, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="ew")
        envio = ["Telegram"]
        self.modo_envio_cb.configure(values=envio)
        self.modo_envio_cb.set(envio[0])
        self.controles['modo_envio_cb'] = self.modo_envio_cb
        linha += 1

        self.label_caminho = ctk.CTkLabel(self.janela_principal, text="Caminho do sistema:")
        self.label_caminho.grid(row=linha, column=0, padx=estilo.PADX_COMPONENTE, pady=estilo.PADY_COMPONENTE, sticky="w")

        self.button_selecionar_origem = ctk.CTkButton(self.janela_principal, text="Selecionar pasta do sistema de notas")
        ...
        self.entrada_caminho = ctk.CTkEntry(self.janela_principal)
        ...
        self.checkbox_rel = ctk.CTkCheckBox(self.janela_principal, text="Gerar relatório:", variable=self.checkbox_relatorio)
        ...
        self.checkbox_sis = ctk.CTkCheckBox(self.janela_principal, text="Configurar segundo sistema:", variable=self.checkbox_sistema)
        ...
        # Área de texto
        self.text_area = ctk.CTkTextbox(self.janela_principal, width=50, height=75)
        ...
        self.button_gravar = ctk.CTkButton(self.janela_principal, text="Gravar")
